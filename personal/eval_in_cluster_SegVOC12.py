...
# ------------- Examples of usage --------------
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py HED     read_one_cont_png fb 1 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py LEP     read_one_lep      fb 0 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py MCG     read_one_ucm      fb 0 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py gPb-UCM read_one_ucm      fb 0 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py NWMC    read_one_ucm      fb 0 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py IIDKL   read_one_ucm      fb 0 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py EGB     read_one_prl      fb 0 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py MShift  read_one_prl      fb 0 100
# qsub -N evalFb -t 1-100 eval_in_cluster_SegVOC12.py NCut    read_one_prl      fb 0 100

# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py LEP     read_one_lep      fop 0 20
# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py MCG     read_one_ucm      fop 0 20
# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py gPb-UCM read_one_ucm      fop 0 20
# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py NWMC    read_one_ucm      fop 0 20
# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py IIDKL   read_one_ucm      fop 0 20
# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py EGB     read_one_prl      fop 0 20
# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py MShift  read_one_prl      fop 0 20
# qsub -N evalFop -t 1-20 eval_in_cluster_SegVOC12.py NCut    read_one_prl      fop 0 20
